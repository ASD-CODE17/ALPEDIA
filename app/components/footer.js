    ...
    <footer className="bg-gray-800 py-8 text-white mt-16 border-t-4 border-gray-200"> 
        ...
        <div className="flex flex-wrap justify-between text-gray-400">
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <p className="text-sm">
              AL STURE sekarang menyediakan Tempat top up game termurah, tercepat, dan terpercaya di Indonesia. Proses Otomatis cepat dan lancar! Tersedia berbagai macam pembayaran Transfer Bank, E-Wallet, Scan QR, Alfamart, & Indomart yg pasti memudahkan anda untuk bertransaksi.
            </p>
          </div>
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
